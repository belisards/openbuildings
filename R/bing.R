...
#' library(sf)
#' geometries_sf <- st_as_sf(do.call(rbind, geometries))
#' 
#' 
#' # Combine geometries and properties into a single sf object
#' features_sf <- cbind(geometries_sf, do.call(rbind, properties))
#' 
#' # Convert geometries to SF objects
